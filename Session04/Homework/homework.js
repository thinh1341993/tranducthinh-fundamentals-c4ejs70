...
//     expectedHours: 0.5,
//     };
// var {subject,createdBy,assignTo,dueDate} = task
...
// while(true){
//     alert('Hi there, this is dev dictionary')
//     let keys = prompt('Enter the keyword')
//     if(keys in dictionary){
//           alert(keys+'\n'+dictionary[keys])
//         }else{
//             dictionary[keys] = prompt('We could not find your word: '+keys+', leave your explanation')
//             alert('Done') 
//         }
//     }
// 5.
...
// smartphone.forEach((value, index) => {
...
// let provide = prompt('Enter your provide')
// smartphone.forEach((value, index) => {
//     Object.keys(value).forEach(item => {
//         if (value[item] == value.providers) {
//             let ar = value[item]
//             arr = ar.split(' ')
...
//         frontend.push({ name: newname, complete: 'false' })
//         frontend.forEach((value, index) => {
//             console.log(`${index + 1}. ` + value.name + '\n' + `Complete: ${value.complete}`)
//         })
...
//         let c_position =Number(prompt('Enter your position:'))
//         frontend.forEach((value, index) => {
//             index = index + 1
//             if (index == c_position) {
//                 value.complete = true
//             }
//             if (value.complete){
//                 console.log(`${index}. ` +'[x] '+ value.name + '\n' + `Complete: ${value.complete}`)
//             } else {
//                 console.log(`${index}. ` +'[ ] '+ value.name + '\n' + `Complete: ${value.complete}`)
//             }
//         })
//     } else if (userinput === 'Delete') {
//         let xoa =Number(prompt('Enter your position:'))
//         frontend.splice(xoa-1,1)
//         frontend.forEach((value, index) => {
//             index = index + 1
//             console.log(`${index}. ` + value.name + '\n' + `Complete: ${value.complete}`)
//         })
...
//     let { shape, x, y, width, height } = value
//     if (value.shape == 'rect') {
//         penup()
//         rt(90)
//         fd(x)
